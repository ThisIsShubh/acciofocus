       ...
       {/* Hero section */}
        ...
        <section className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white/70 rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg text-green-500 mb-1">Solo Study</h3>
          ...
          <div className="bg-white/70 rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg text-green-500 mb-1">Group Rooms</h3>
          ...
          <div className="bg-white/70 rounded-xl p-6 shadow flex flex-col items-center">
            ...
            <h3 className="font-bold text-lg text-green-500 mb-1">Track Progress</h3>
